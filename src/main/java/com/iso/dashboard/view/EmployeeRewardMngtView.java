...
import com.iso.dashboard.controller.EmployeeRewardMngtController;
 ...
 */
public class EmployeeRewardMngtView extends VerticalLayout implements View {

    private TextField txtEmployeeReward;
...
//    private ComboBox cmbStatus;
    ...
    public EmployeeRewardMngtView() {
        ...
        addComponent(root);
        new EmployeeRewardMngtController(this);
    }
    ...
    private HorizontalLayout buildSearchForm() {
        ...
        txtEmployeeReward = new TextField();
        txtEmployeeReward.setImmediate(true);
        txtEmployeeReward.setInputPrompt(BundleUtils.getString("common.button.search"));
        txtEmployeeReward.setWidth("100.0%");
        txtEmployeeReward.setHeight(Constants.STYLE_CONF.AUTO_VALUE);
        searchForm.addComponent(txtEmployeeReward);
    ...
    public TextField getTxtEmployeeReward() {
        return txtEmployeeReward;
    }

    public void setTxtEmployeeReward(TextField txtEmployeeReward) {
        this.txtEmployeeReward = txtEmployeeReward;
    }
