...
import com.iso.dashboard.controller.StepMngtController;
 ...
 * @author VIET_BROTHER
 */
public class StepMngtView extends Panel implements View {
...
//        tabSheet.setCaption(BundleUtils.getStringCas("menu.userMngt"));
    ...
    private HorizontalLayout buildSearchForm() {
        ...
        txtName.setInputPrompt(BundleUtils.getString("stepMgnt.list.name"));
