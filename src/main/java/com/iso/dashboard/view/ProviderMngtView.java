...
import com.iso.dashboard.controller.ProviderMngtController;
 ...
 */
public class ProviderMngtView extends Panel implements View {
...
//        setSpacing(false);
        ...
        root.setCaption(BundleUtils.getStringCas("menu.providerMngt"));
        root.setSizeFull();
...
//        addComponent(buildToolbar());
        new ProviderMngtController(this);
    }
...
//            job.setUserName(i + "_native");
    ...
    private HorizontalLayout buildSearchForm() {
        ...
        txtProvider.setImmediate(true);
        txtProvider.setInputPrompt(BundleUtils.getString("assetTypeMngt.list.name"));
        txtProvider.setWidth("100.0%");
        txtProvider.setHeight(Constants.STYLE_CONF.AUTO_VALUE);
        searchForm.addComponent(txtProvider);
    ...
    public TextField getTxtProvider() {
        return txtProvider;
    }

    public void setTxtProvider(TextField txtProvider) {
