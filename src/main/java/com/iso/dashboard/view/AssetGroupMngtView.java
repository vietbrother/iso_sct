...
import com.iso.dashboard.controller.AssetGroupMngtController;
 ...
 */
public class AssetGroupMngtView extends Panel implements View {

    private TextField txtAssetGroup;
    ...
    public List<AssetGroup> assetTypes = new ArrayList<>();

    public AssetGroupMngtView() {
        setSizeFull();
...
//        setSpacing(false);
        ...
        root.setCaption(BundleUtils.getStringCas("menu.assetGroupMngt"));
        root.setSizeFull();
...
//        addComponent(buildToolbar());
        new AssetGroupMngtController(this);
    }
...
//            job.setUserName(i + "_native");
    ...
    private HorizontalLayout buildSearchForm() {
        ...
        txtAssetGroup = new TextField();
        txtAssetGroup.setImmediate(true);
        txtAssetGroup.setInputPrompt(BundleUtils.getString("assetTypeMngt.list.name"));
        txtAssetGroup.setWidth("100.0%");
        txtAssetGroup.setHeight(Constants.STYLE_CONF.AUTO_VALUE);
        searchForm.addComponent(txtAssetGroup);
    ...
    public TextField getTxtAssetGroup() {
        return txtAssetGroup;
    }

    public void setTxtAssetGroup(TextField txtAssetGroup) {
        this.txtAssetGroup = txtAssetGroup;
    }
    ...
    public void setAssetGroups(List<AssetGroup> assetTypes) {
