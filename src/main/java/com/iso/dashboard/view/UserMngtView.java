...
//    private CustomPageTable pagedTable;
    ...
    public List<User_> userList = new ArrayList<>();
...
//        table.setSizeFull();
//        table.setContainerDataSource(new BeanItemContainer<>(User_.class, userList));
...
//                for (User_ user : userList.subList(event.fromIndex(), event.toIndex())) {
//                    table.addItem(user);
//                }
//            }
//        });
