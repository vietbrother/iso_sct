...
import com.iso.dashboard.controller.AssetTypeMngtController;
 ...
 */
public class AssetTypeMngtView extends Panel implements View {
    ...
    public List<AssetType> assetTypes = new ArrayList<>();

    public AssetTypeMngtView() {
        setSizeFull();
...
//        setSpacing(false);
        ...
        root.setCaption(BundleUtils.getStringCas("menu.assetTypeMngt"));
        root.setSizeFull();
...
//        addComponent(buildToolbar());
        new AssetTypeMngtController(this);
    }
...
//            job.setUserName(i + "_native");
    ...
    private HorizontalLayout buildSearchForm() {
        ...
        txtAssetType = new TextField();
        txtAssetType.setImmediate(true);
        txtAssetType.setInputPrompt(BundleUtils.getString("assetTypeMngt.list.name"));
        txtAssetType.setWidth("100.0%");
        txtAssetType.setHeight(Constants.STYLE_CONF.AUTO_VALUE);
        searchForm.addComponent(txtAssetType);
    ...
    public TextField getTxtAssetType() {
        return txtAssetType;
    }

    public void setTxtAssetType(TextField txtAssetType) {
        this.txtAssetType = txtAssetType;
    }
