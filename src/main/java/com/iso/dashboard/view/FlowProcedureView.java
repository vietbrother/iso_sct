...
import com.iso.dashboard.controller.FlowProcedureController;
import com.iso.dashboard.controller.FlowStepController;
 ...
 * @author VIET_BROTHER
 */
public class FlowProcedureView extends TabSheet implements View {
    ...
    public FlowProcedureView(Integer taskId) {
        setSizeFull();
        ...
        new FlowProcedureController(this, taskId);
    }
