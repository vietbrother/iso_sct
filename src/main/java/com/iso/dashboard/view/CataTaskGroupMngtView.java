...
import com.iso.dashboard.component.CustomGridEditRow;
import com.iso.dashboard.controller.TaskGroupController;
 ...
 * @author VIET_BROTHER
 */
public class CataTaskGroupMngtView extends Panel implements View {
    ...
    public CataTaskGroupMngtView() {
        setSizeFull();
        addStyleName(ValoTheme.PANEL_BORDERLESS);
        setSizeFull();
        VerticalLayout root = new VerticalLayout();
        root.setCaption(BundleUtils.getStringCas("menu.taskGroupMngt"));
        root.setSizeFull();
