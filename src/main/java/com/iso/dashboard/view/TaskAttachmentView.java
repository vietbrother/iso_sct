...
import com.iso.dashboard.controller.TaskAttachmentController;
 ...
 * @author VIET_BROTHER
 */
public class TaskAttachmentView extends TabSheet implements View {
...
//        setSpacing(false);
        ...
        root.setCaption(BundleUtils.getStringCas("menu.taskReportMngt"));
        root.setWidth("98%");
...
//        tabSheet.addComponent(root);
        ...
        new TaskAttachmentController(this);
    }
