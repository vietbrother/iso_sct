...
public class FooterView extends HorizontalLayout {
    ...
    public FooterView() {
        ...
        Label labelFooter = new Label("", ContentMode.HTML);
        labelFooter.setValue("<div class=\"span3 logo\">\n"
...
//        Image image = new Image(null, new ThemeResource("img/logo_so_y_te_ha_giang.png"));
        ...
        temp.setWidth("100%");
        temp.setHeight("100%");
        temp.addStyleName("login-register-layout");
        ...
        addComponent(temp);
        setExpandRatio(temp, 1.9f);
        temp.addComponent(registerBtn);
        temp.setComponentAlignment(registerBtn, Alignment.TOP_LEFT);
        temp.addComponent(loginBtn);
        temp.setComponentAlignment(loginBtn, Alignment.TOP_LEFT);
