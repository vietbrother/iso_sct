...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2017 at 10:03 AM
...
(3, 'TAI_LIEU_01', 'Tài liệu quy trình nghiệp vụ Y', 'Cứng', 'Trung bình', 'Admin', 'Đã lưu', 36, 12, '../data/test.pdf'),
...
(3, '121212', '12', '12', '12', '1', '2017-11-04', '1', '2017-11-04', '1'),
...
(4, 2, 4, 1, NULL, NULL, 1, NULL, '1;5;10'),
(5, 3, 3, NULL, NULL, NULL, 1, NULL, NULL);
...
(1, 1, 1, '1', '1', 'ad', 'ad', '2017-11-10 15:41:39', '2017-11-10 15:41:39'),
(2, 1, 1, '1', '1', 'ad', 'ad', '2017-11-10 15:42:54', '2017-11-10 15:42:54'),
(3, 1, 2, '1', '1', 'ad', 'ad', '2017-11-10 15:42:55', '2017-11-10 15:42:55'),
(4, 2, 2, '2', '1', 'ad', 'ad', '2017-11-10 15:42:55', '2017-11-10 15:42:55'),
...
--
ALTER TABLE `c_flow`
  MODIFY `FLOW_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `c_procedure`
  MODIFY `C_PROCEDURE_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `m_procedure_document`
  MODIFY `M_PROCEDURE_DOCUMENT_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
