...
import com.iso.dashboard.controller.AssetClassMngtController;
 ...
 */
public class AssetClassMngtView extends Panel implements View {

    private TextField txtAssetClass;
    ...
    public List<AssetClass> assetTypes = new ArrayList<>();

    public AssetClassMngtView() {
        setSizeFull();
...
//        setSpacing(false);
        ...
        root.setCaption(BundleUtils.getStringCas("menu.assetClassMngt"));
        root.setSizeFull();
...
//        addComponent(buildToolbar());
        new AssetClassMngtController(this);
    }
...
//            job.setUserName(i + "_native");
    ...
    private HorizontalLayout buildSearchForm() {
        ...
        txtAssetClass = new TextField();
        txtAssetClass.setImmediate(true);
        txtAssetClass.setInputPrompt(BundleUtils.getString("assetTypeMngt.list.name"));
        txtAssetClass.setWidth("100.0%");
        txtAssetClass.setHeight(Constants.STYLE_CONF.AUTO_VALUE);
        searchForm.addComponent(txtAssetClass);
    ...
    public TextField getTxtAssetClass() {
        return txtAssetClass;
    }

    public void setTxtAssetClass(TextField txtAssetClass) {
        this.txtAssetClass = txtAssetClass;
    }
    ...
    public List<AssetClass> getAssetClasss() {
        return assetTypes;
    }

    public void setAssetClasss(List<AssetClass> assetTypes) {
