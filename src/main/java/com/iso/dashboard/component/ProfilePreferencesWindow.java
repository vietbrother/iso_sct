...
public class ProfilePreferencesWindow extends Window {
    ...
    /*
     * Fields for editing the Employee object are defined here as class members.
...
//    private RadioButtonGroup<Boolean> sexField;
    ...
    private ProfilePreferencesWindow(final Employee user,
    ...
    private Component buildPreferencesTab() {
        ...
        root.setCaption(BundleUtils.getString("login.preferences"));
    ...
    private Component buildProfileTab() {
        ...
        root.setCaption(BundleUtils.getString("login.editProfile"));
...
//        websiteField.setPlaceholder("http://");
    ...
    public static void open(final Employee user,
